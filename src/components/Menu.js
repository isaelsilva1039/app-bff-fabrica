...
function Menu() {
  return (
    <Navbar expand="lg" className="bg-primary text-white">
      <Container>
        {/* Logo atrás do nome "Pulse" */}
        <Navbar.Brand as={Link} to="/fabricantes" style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
          {/* Imagem da logo */}
          <img 
          ...
          />
          <span style={{ marginLeft: '40px', fontWeight:700 }}>Fabrica Mateus</span> {/* Nome "Pulse" ao lado da logo */}
        </Navbar.Brand>
